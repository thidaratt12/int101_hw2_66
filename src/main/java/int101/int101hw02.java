...
public class int101hw02 {
    ...
    static void work01Utilitor() {
        System.out.println("testString(\"Hello World\") return " + testString("Hello World"));
        System.out.println("testPositive(1) return " + testPositive(1));
        System.out.println("computIsbn10(123456789) return " + computeIsbn10(922155435));
       /*
